...
- [Project Mv Markets Rs Detail Charts State](project_mv_markets_rs_detail_charts_state.md) — 
- [Project Mv Sector Deepdive State](project_mv_sector_deepdive_state.md) — 
- [""](project_mv_sector_rrg_state.md) — 
- [Sprint 7 Coverage Push — Current State](project_sprint7_coverage_state.md) — Backend data coverage analysis results + all surface changes deployed as of 2026-05-11
- [Reference V6 Worktree](reference_v6_worktree.md) — v6 worktree path, branch, key file locations, how to run
