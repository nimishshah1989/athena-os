...
As of 2026-07-07: P1 (profile intake), P2 (generation engine), P2.5 (revision loop) built and verified; next build is P3 (job discovery) → P4 (tracker, Gmail apply+scouting, interview prep). User (non-technical founder) is procuring Adzuna/JSearch/Google-OAuth keys — build against stubs until keys arrive in chat.

**Why:** the founder clears conversations between sessions; this pointer prevents re-deriving context or contradicting settled decisions.

**How to apply:** open STATE.md + HANDOFF.md before any CareerPlus work; never re-litigate D-numbered decisions without a DECISIONS-LOG entry.
